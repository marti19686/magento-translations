...
namespace OneMoment\I18nAutoTranslator\Console\Command;
...
class I18nAutoTranslateCommand extends Command
{
    /**#@+
    ...
    {
        $this->setName('i18n:auto-translate')
            ->setDescription('Translate phrases in the codebase');
        $this->setDefinition([
            new InputArgument(
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<info>Dictionary successfully translate.</info>');
